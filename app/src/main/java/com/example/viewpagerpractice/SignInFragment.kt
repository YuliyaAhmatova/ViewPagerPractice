...
class SignInFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loginSignInBTN.setOnClickListener {
            if (name != userNameSignInET.text.toString() || password != passwordSignInET.text.toString()) {
                Toast.makeText(context, "Введены неверно пароль или логин", Toast.LENGTH_LONG)
                    .show()
